...
function nestedFunctions() {
  ...
  return nestedAdd(9)(3)(5)

  function nestedAdd(a) {
    return function(b) {
      return function(c) {
        return a + b + c
      }
...
function nestedFunctionsSOLUTION() {
  const nestedAdd = a => b => c => a + b + c
  return nestedAdd(9)(3)(5)
}
// log(nestedFunctionsSOLUTION())
